...
import { Handshake, Mail, FileText } from 'lucide-react';
...
export function PartnerExpiryHistory() {
  ...
  const list = rows ?? [];   // 이미 sent_at desc (발송시간 역순)
    ...
    <div className="border-t border-border">
      ...
      <div className="px-2 pb-3">
        {list.length === 0 ? (
          ...
          // 약 5개 노출 + 스크롤 (행 높이 ~52px)
          <div className="divide-y divide-border max-h-[270px] overflow-y-auto">
            {list.map(r => {
