...
const PRICING: Record<number, Record<string, number>> = {
  1:  { '소수학급플랜': 10000, '학급플랜':  40000, '학년플랜':  180000, '학교(소)':  440000, '학교(중)':  850000, '학교(대)':  1200000 },
  ...
  7:  { '럭키세븐이벤트플랜': 100000 },   // 5월 한정 이벤트 — 1장 10만원
...
export const S2B_MAP: Record<string, Record<number, string>> = {
  ...
  '캠페인':   { 1: '202502100673587' },
  '럭키세븐이벤트플랜': { 7: '' },         // S2B 미등록 (이벤트용)
};
