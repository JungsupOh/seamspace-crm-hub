        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link to="/shop/lucky-seven" className="group text-center">
              <div className="relative rounded-xl overflow-hidden border border-border hover:shadow-lg transition-shadow mb-2">
                <img src="/events/lucky-seven/lucky-seven-thumnail-2.png" alt="럭키세븐 이벤트" className="w-full group-hover:scale-105 transition-transform duration-300" />
